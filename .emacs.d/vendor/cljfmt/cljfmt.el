...
;; (version 1.3.1), which is Copyright 2013 The go-mode Authors, and goverened
;; by the BSD License.
...
(defun cljfmt ()
  ...
  (let ((tmpfile (make-temp-file "cljfmt" nil ".go"))
    ...
    (save-restriction
      ...
      (if (zerop (call-process cljfmt-command nil errbuf nil "-w" "-enable-transform" "remove-unused-requires" tmpfile))
          (progn
...
you save any file, kind of defeating the point of autoloading."
  ...
  (interactive)
  (when (eq major-mode 'clojure-mode) (cljfmt)))
